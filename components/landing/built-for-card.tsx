...
const BuiltForCard = ({ title, description, icon }: BuiltForCardProps) => {
  return (
    <div className="pt-6 px-6 pb-6 border border-gray-200 rounded-2xl flex flex-col items-center md:items-start gap-4 md:gap-6">
      <Image
        src={icon}
        alt={title}
        width={100}
