...
const KeyFeatures = () => {
  return (
    <section
      id="key-features"
      className="max-w-[1440px] max-h-[722px] flex items-center justify-center mx-auto font-sans px-3 sm:px-8 md:px-12 pt-10 md:pt-15 lg:pt-20 pb-6 md:pb-20 lg:pb-[105px]"
    >
