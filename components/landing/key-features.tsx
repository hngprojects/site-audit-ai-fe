...
const KeyFeatures = () => {
  return (
    <section
      id="key-features"
      className="max-w-[1344px] flex items-center justify-center mx-auto font-sans px-5 md:px-12 2xl:px-0 pt-10 md:pt-15 lg:pt-20 pb-6 md:pb-20 lg:pb-[105px]"
    >
      <div className=" w-full mx-auto flex flex-col items-center gap-6 lg:gap-16">
        <div className="flex flex-col gap-2 md:gap-4 text-center max-w-[754px]">
          <h2 className="text-2xl md:text-[32px] lg:text-[40px] leading-7 md:leading-10 font-semibold ">
