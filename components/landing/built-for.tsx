...
const BuiltFor = () => {
  const column1 = landingBuiltforData.slice(0, 2); // items 1 & 2
  const column2 = landingBuiltforData.slice(2, 3); // item 3
  const column3 = landingBuiltforData.slice(3, 5); // items 4 & 5
  return (
    <section className="max-w-[1440px]font-sans pt-10 md:pt-20 pb-6 md:pb-25 relative min-h-screen font-sans">
      <div className=" mx-auto flex flex-col items-center justify-center gap-4 md:gap-10 px-0 md:px-10 ">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center gap-6 lg:gap-8  px-4 ">
          {/* Column 1 */}
