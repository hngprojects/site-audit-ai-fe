...
const HowITWorks = () => {
  return (
    <section
      ...
      className="max-w-[1344px] max-h-[800px] flex items-center justify-center mx-auto font-sans px-5  md:px-12 2xl:px-0 pt-10 md:pt-15 pb-6 md:pb-20 lg:pb-[105px] scroll-mt-20"
    >
